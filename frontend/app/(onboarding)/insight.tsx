...
export default function InsightScreen() {
  ...
  const { conditions, symptoms, completeOnboarding } = useUserStore();
  ...
  const phase = lastPeriodDate
    ? getCurrentPhase(lastPeriodDate, cycleLength)
    : null;
        ...
        {!aha && (
          <Animated.View entering={FadeInUp.duration(600).delay(200)} style={styles.card}>
            ...
            <Text style={styles.insightBody}>
              as you share more about your days, milli will start connecting the dots between your cycle, symptoms, and daily life.
            </Text>
          </Animated.View>
        )}
      </View>
